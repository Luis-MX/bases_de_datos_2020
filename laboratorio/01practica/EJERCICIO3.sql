...
CREATE TABLE hotel.AGENCIA (
ID_AGENCIA NUMBER(5) CONSTRAINT AGENCIA_PK PRIMARY KEY,
TELEFONO VARCHAR2(20) CONSTRAINT AGENCIA_TEL_NN NOT NULL,
NOMBRE VARCHAR2(50) CONSTRAINT AGENCIA_NOM_NN NOT NULL,
COLONIA VARCHAR2(50) CONSTRAINT AGENCIA_COL_NN NOT NULL,
CALLE VARCHAR2(50),
...
NOMBRE VARCHAR2(50) CONSTRAINT EMPLEADO_NOM_NN NOT NULL,
APELLIDO_PATERNO VARCHAR2(50) CONSTRAINT EMPLEADO_APPATERNO_NN NOT NULL,
APELLIDO_MATERNO VARCHAR2(50) CONSTRAINT EMPLEADO_APMATERNO_NN NOT NULL,
CONSTRAINT EMPLEADO_TEL_UK UNIQUE(TELEFONO)
);


CREATE TABLE hotel.EMPLEADO_AGENCIA(
...
NOMBRE VARCHAR(50) CONSTRAINT HABITACION_NOM_NN NOT NULL,
...
NOMBRE VARCHAR(50) CONSTRAINT HOTEL_NOM_NN NOT NULL,
TELEFONO VARCHAR2(50) CONSTRAINT HOTEL_TEL_NN NOT NULL,
FECHA_CONSTRUCCION DATE CONSTRAINT HOTEL_FECHA_NN NOT NULL,
COLONIA VARCHAR2(50) CONSTRAINT HOTEL_COL_NN NOT NULL,
CALLE VARCHAR2(50),
...
CREATE TABLE hotel.HABITACION_HOTEL(
